...
int cod_liga=0;
ArrayList<Equipo>equipos=controladorBD.dameEquiposLiga(cod_liga);
%>
							...
							<!-- Content -->
								...
								<table class="alt">
									...
									<%for (int i=0;i<ligas.size();i++){ %>
										...
										<tr>
											<td width='60' rowspan="2"><img src="images/ligas/<%=ligas.get(i).getCod_liga()%>.png" width=50 /></td>
											<td width='300' colspan="3" style="padding-left: 15px;"><%= ligas.get(i).getNombre() %></td>
											<% for(int j=0; j<equipos.size();j++){ %>
											<td rowspan="2" width='60' style="text-align: center;"><img src="images/equipos/<%=equipos.get(j).getCod_equipo()%>.png" width=50 /></td>	
											<%} %>									
										</tr>
										<tr>
										  
										  <td width='50' style="text-align: left; padding-left: 14px;"><img src="images/paises/<%=ligas.get(i).getPais() %>.png" width=30 /></td>
										  <td width='205'></td>
										</tr>
									<%} %>
